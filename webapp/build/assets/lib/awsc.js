!(function (e, t) {
  var o = 1e4,
    g_moduleConfig = {
      ...
      fyModule: {
        grey: ["AWSC/fireyejs/1.212.0/fireyejs.js"],
        stable: ["AWSC/fireyejs/1.212.0/fireyejs.js"],
        greyBr: ["AWSC-br/fireyejs/1.212.0/fireyejs.js"],
        stableBr: ["AWSC-br/fireyejs/1.212.0/fireyejs.js"],
        ratio: 10000,
        greyConfig: {},
        stableConfig: {},
      },
  ...
  function d(t, o) {
    ...
    if (e[n]) return e[n];
    var a = { normalAddresses: [], brAddresses: [] };
    for (var d in g_moduleConfig)
      if (g_moduleConfig.hasOwnProperty(d) && d === t) {
        ...
        (a.normalAddresses = m ? f.grey.slice() : f.stable.slice()),
          f.stableBr &&
            f.greyBr &&
            (a.brAddresses = m ? f.greyBr.slice() : f.stableBr.slice()),
          "etModule" === t &&
            (i || r
              ? (a.normalAddresses.pop(), a.brAddresses.pop())
              : s || l || c
              ? (a.normalAddresses.shift(), a.brAddresses.shift())
              : u()
              ? (a.normalAddresses.pop(), a.brAddresses.pop())
              : (a.normalAddresses.shift(), a.brAddresses.shift()));
      ...
      function i(e, n, a) {
        for (var r = 0; r < e.length; r++) {
          ...
          l && l.parentNode
            ...
            : (l = t.body || t.head) && l.appendChild(s);
        }
      }
      i(e.normalAddresses);
    }
    ...
    try {
      ...
      for (var r = void 0, i = 0; i < f.length; i++) {
        ...
        s.module === a &&
          ...
          (r.exportObj = o),
          ("loading" === s.state || "timeout" === s.state) &&
            ((r.state = "loaded"),
            setTimeout(function () {
              T(r, n);
            }, 0)));
  ...
  function E(e) {
    var t = g_moduleConfig.etModule,
      o,
      n =
        Math.ceil(1e4 * Math.random()) <= t.ratio
          ? t.greyConfig.whitelist
          : t.stableConfig.whitelist,
      a;
    new RegExp(("^" + n.join("$|^") + "$").replace(/\*/g, ".*")).test(
