/*
    ...
    Release Date: Fri Sep 04 2020 08:13:28 GMT+0800 (China Standard Time)
    CodeVersion: e7b4193dcf3811c2cd365d133c70e56342269064
*/
(function (global, factory) {
  ...
  // console.warn('SDK VERSION:', 'e7b4193dcf3811c2cd365d133c70e56342269064')
  ...
  (function (RongIMLib) {
    ...
    (function (ConnectionStatus) {
       ...
       */
      ConnectionStatus[
        (ConnectionStatus["KICKED_OFFLINE_BY_OTHER_CLIENT"] = 6)
      ...
      /*
            开始请求导航
        */
      ConnectionStatus[(ConnectionStatus["REQUEST_NAVI"] = 201)] =
        "REQUEST_NAVI";
      /*
            请求导航结束
        */
      ConnectionStatus[(ConnectionStatus["RESPONSE_NAVI"] = 202)] =
        "RESPONSE_NAVI";
      /*
            请求导航失败
        */
    ...
    (function (ConversationNotificationStatus) {
      ...
      ConversationNotificationStatus[
        (ConversationNotificationStatus["DO_NOT_DISTURB"] = 1)
      ] = "DO_NOT_DISTURB";
      /**
       * 提醒。
       */
      ConversationNotificationStatus[
        (ConversationNotificationStatus["NOTIFY"] = 2)
      ] = "NOTIFY";
    })(
    ...
    (function (ErrorCode) {
      ...
      ErrorCode[(ErrorCode["RC_MSG_UNAUTHORIZED"] = 20406)] =
        "RC_MSG_UNAUTHORIZED";
      /**
       * 群组 Id 无效
       */
       ...
       * 聊天室成员已满
       */
      ErrorCode[(ErrorCode["RC_CHATROOM_IS_FULL"] = 23411)] =
        "RC_CHATROOM_IS_FULL";
      /**
       * 获取聊天室信息参数无效
       */
       ...
       */
      ErrorCode[(ErrorCode["CHATROOM_KV_EXCEED"] = 23423)] =
        "CHATROOM_KV_EXCEED";
      /**
       * 聊天室 KV 设置失败(kv 已存在, 需覆盖设置)
       */
      ErrorCode[(ErrorCode["CHATROOM_KV_OVERWRITE_INVALID"] = 23424)] =
        "CHATROOM_KV_OVERWRITE_INVALID";
      /**
       * 聊天室 KV 存储功能没有开通
       */
      ErrorCode[(ErrorCode["CHATROOM_KV_STORE_NOT_OPEN"] = 23426)] =
        "CHATROOM_KV_STORE_NOT_OPEN";
      /**
       * 聊天室Key不存在
       */
      ErrorCode[(ErrorCode["CHATROOM_KEY_NOT_EXIST"] = 23427)] =
       ...
       * */
      ErrorCode[(ErrorCode["RC_MSG_CONTENT_EXCEED_LIMIT"] = 30016)] =
      ...
      ErrorCode[(ErrorCode["CONVER_CLEAR_ERROR"] = 34007)] =
        "CONVER_CLEAR_ERROR";
       ...
       * 聊天室 kv 未找到
       * */
      ErrorCode[(ErrorCode["CHATROOM_KV_NOT_FOUND"] = 36004)] =
      ...
      /*!
         对方网络错误
         */
      ErrorCode[(ErrorCode["REMOTE_NETWORK_ERROR"] = 17)] =
  ...
  (function (RongIMLib) {
    var RongIMClient = (function () {
      ...
      RongIMClient.init = function (
        ...
        RongIMClient.Conversation =
          RongIMClient._dataAccessProvider.Conversation;
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.A_INIT_O,
          level: RongIMLib.LoggerLevel.I,
          type: RongIMLib.LoggerType.IM,
          content: {
            appKey: appKey,
          },
        });
      ...
      RongIMClient.setProtocol = function (protocol) {
        RongIMClient._memoryStore.depend =
          RongIMClient._memoryStore.depend || {};
      ...
      RongIMClient.getProtocol = function () {
        ...
        var protocol = depend.protocol,
          wsScheme = depend.wsScheme;
      ...
      RongIMClient.connect = function (token, _callback, userId, serverConf) {
        ...
        if (RongIMLib.IMHandler.isIncludeNavi(token)) {
          ...
          RongIMClient._memoryStore.depend.navigaters =
            RongIMLib.RongUtil.concat(navList, currentNavs, true);
        }
        var connectCallback = {
      ...
      RongIMClient.setConnectionStatusListener = function (listener) {
        if (RongIMClient._dataAccessProvider) {
          RongIMClient._dataAccessProvider.setConnectionStatusListener(
            listener
          );
        } else {
          if (
            RongIMLib.RongUtil.isObject(listener) &&
            RongIMLib.RongUtil.isFunction(listener.onChanged)
          ) {
      ...
      RongIMClient.setOnReceiveMessageListener = function (listener) {
        if (RongIMClient._dataAccessProvider) {
          RongIMClient._dataAccessProvider.setOnReceiveMessageListener(
            listener
          );
        } else {
          if (
            RongIMLib.RongUtil.isObject(listener) &&
            RongIMLib.RongUtil.isFunction(listener.onReceived)
          ) {
      ...
      RongIMClient.prototype.disconnect = function () {
        ...
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.A_DISC_O,
          level: RongIMLib.LoggerLevel.I,
          type: RongIMLib.LoggerType.IM,
        });
      };
      ...
      RongIMClient.prototype.setOfflineMessageDuration = function (
        duration,
        callback
      ) {
        RongIMLib.CheckParam.getInstance().check(
        ...
        RongIMClient._dataAccessProvider.setOfflineMessageDuration(
          duration,
          callback
        );
      };
      ...
      RongIMClient.prototype.setConversationStatus = function (
        type,
        targetId,
        statusItem,
        callback
      ) {
        RongIMClient._dataAccessProvider.setConversationStatus(
          type,
          targetId,
          statusItem,
          callback
      ...
      RongIMClient.prototype.sendRecallMessage = function (
        ...
        RongIMClient._dataAccessProvider.sendRecallMessage(
          content,
          callback,
          params
        );
      ...
      RongIMClient.prototype.setMessageSearchField = function (
        ...
        RongIMClient._dataAccessProvider.setMessageSearchField(
          messageId,
          content,
          searchFiles
        );
      ...
      RongIMClient.prototype.deleteRemoteMessages = function (
        ...
        RongIMClient._dataAccessProvider.deleteRemoteMessages(
          conversationType,
          targetId,
          messages,
          RongIMClient.logCallback(callback, "deleteRemoteMessages")
        );
      };
      /**
            ...
            onSuccess: function (conver) {
              ...
              if (!isUseReplace) {
                if (RongIMLib.RongUtil.supportLocalStorage()) {
                  ...
                  conver.unreadMessageCount = RongIMLib.UnreadCountHandler.get(
                    tempConver.type,
                    tempConver.userId
                  );
                } else {
              ...
              var status =
                RongIMClient._dataAccessProvider.conversationStatusManager.get(
                  tempConver.type,
                  tempConver.userId
                );
      ...
      RongIMClient.prototype.addConversation = function (
        ...
        RongIMClient._dataAccessProvider.addConversation(
          conversation,
          callback
        );
      };
      RongIMClient.prototype.sortConversationList = function (
        ...
        return (RongIMClient._memoryStore.conversationList =
          convers.concat(conversationList));
      };
        ...
        RongIMClient._dataAccessProvider.getConversationList(
          {
            onSuccess: function (data) {
              if (conversationTypes || RongIMClient._dataAccessProvider) {
                ...
                setTimeout(function () {
                  callback.onSuccess(
                    RongIMClient._memoryStore.conversationList
                  );
                });
              }
            },
      ...
      RongIMClient.prototype.updateConversation = function (conversation) {
        return RongIMClient._dataAccessProvider.updateConversation(
          conversation
        );
      };
      /**
      ...
      RongIMClient.prototype.setChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
        ...
        RongIMClient._dataAccessProvider.setChatroomEntry(
          chatroomId,
          chatroomEntry,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      };
      RongIMClient.prototype.forceSetChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
        ...
        RongIMClient._dataAccessProvider.forceSetChatroomEntry(
          chatroomId,
          chatroomEntry,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      };
      RongIMClient.prototype.getChatroomEntry = function (
        chatroomId,
        key,
        callback
      ) {
        ...
        RongIMClient._dataAccessProvider.getChatroomEntry(
          chatroomId,
          key,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      };
      RongIMClient.prototype.getAllChatroomEntries = function (
        chatroomId,
        callback
      ) {
        RongIMLib.CheckParam.getInstance().check(
        ...
        RongIMClient._dataAccessProvider.getAllChatroomEntries(
          chatroomId,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      };
      RongIMClient.prototype.removeChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
        ...
        RongIMClient._dataAccessProvider.removeChatroomEntry(
          chatroomId,
          chatroomEntry,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      };
      RongIMClient.prototype.forceRemoveChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
        ...
        RongIMClient._dataAccessProvider.forceRemoveChatroomEntry(
          chatroomId,
          chatroomEntry,
          RongIMClient.logCallback(callback, "setChatroomEntry")
        );
      ...
      RongIMClient.prototype.getFileToken = function (
        fileType,
        callback,
        fileName
      ) {
      ...
      RongIMClient.prototype.setUserStatusListener = function (
        ...
        RongIMClient._dataAccessProvider.setUserStatusListener(
          params,
          callback
        );
      };
      ...
      RongIMClient.prototype.removeRTCUserInfo = function (
        ...
        RongIMClient._dataAccessProvider.removeRTCUserInfo(
          room,
          info,
          callback
        );
      ...
      RongIMClient.prototype.removeRTCRoomInfo = function (
        ...
        RongIMClient._dataAccessProvider.removeRTCRoomInfo(
          room,
          info,
          callback
        );
      ...
      RongIMClient.prototype.setRTCUserTotalRes = function (
        roomId,
        message,
        valueInfo,
        objectName,
        ...
        RongIMClient._dataAccessProvider.setRTCUserTotalRes(
          roomId,
          message,
          valueInfo,
          objectName,
  ...
  (function (RongIMLib) {
    ...
    var Channel = (function () {
          ...
          get: function () {
            ...
            var request = function (config, callback) {
              ...
              var timer = setTimeout(function () {
                var onSuccess = function () {
                  ...
                  callback(url);
                  RongIMLib.Logger.writeLog({
                    tag: RongIMLib.LoggerTag.IM.L_PING_WS_R,
                    level: RongIMLib.LoggerLevel.I,
                    type: RongIMLib.LoggerType.IM,
                    content: {
                      url: url,
            ...
            for (var i = 0; i < servers.length; i++) {
              ...
              if (server) {
                ...
                RongIMLib.Logger.writeLog({
                  tag: RongIMLib.LoggerTag.IM.L_PING_WS_T,
                  level: RongIMLib.LoggerLevel.I,
                  type: RongIMLib.LoggerType.IM,
                  content: {
                    url: server,
            ...
            totalTimer.resume(function () {
              ...
              try {
                ...
                !RongIMLib.RongUtil.getValidWsUrlList(storeServers).length &&
        ...
        me.socket.on("StatusChanged", function (code) {
          ...
          setTimeout(function () {
            ...
            var unReportCodes = [
              ...
              RongIMLib.ConnectionStatus.REQUEST_NAVI,
              RongIMLib.ConnectionStatus.RESPONSE_NAVI,
            ];
            var isReportCode =
              RongIMLib.RongUtil.indexOf(unReportCodes, code) === -1;
            if (isReportCode) {
              RongIMLib.Logger.writeLog({
                tag: RongIMLib.LoggerTag.IM.L_NETC_S,
                level: RongIMLib.LoggerLevel.I,
                type: RongIMLib.LoggerType.IM,
                content: {
      ...
      Channel.prototype.changeConnectType = function () {
        RongIMLib.RongIMClient._memoryStore.depend.isPolling =
          !RongIMLib.RongIMClient._memoryStore.depend.isPolling;
        RongIMLib.Transportations._TransportType = RongIMLib.RongIMClient
          ._memoryStore.depend.isPolling
          ? Socket.XHR_POLLING
          : Socket.WEBSOCKET;
    ...
    var Socket = (function () {
      ...
      Socket.prototype.connect = function (url, cb) {
        ...
        if (this.socket) {
          ...
          RongIMLib.RongIMClient._memoryStore.cmpTimeoutTimer = setTimeout(
            function () {
              Bridge._client.handler.connectCallback.readTimeOut(
                true,
                RongIMLib.ErrorCode.RC_CONN_ACK_TIMEOUT
              );
      ...
      Socket.prototype._encode = function (x) {
        var str =
          (x.getMessageId ? "?messageid=" + x.getMessageId() : "") +
          "&header=" +
          x.getHeaderFlag() +
          "&sessionid=" +
      ...
      Client.prototype.invoke = function (isPullMsg, chrmId, offlineMsg) {
        ...
        if (temp.type != 2) {
          ...
          if (!target) {
            ...
            RongIMLib.Logger.writeLog({
              tag: RongIMLib.LoggerTag.IM.L_CHRM_PULL_E,
              level: RongIMLib.LoggerLevel.E,
              type: RongIMLib.LoggerType.IM,
              content: {
                msg: errorMsg,
          ...
          Qos.AT_LEAST_ONCE,
          {
            onSuccess: function (collection) {
              ...
              if (len <= 200 && str == "pullMsg") {
                var Conversation =
                  RongIMLib.RongIMClient._dataAccessProvider.Conversation;
            ...
            onError: function (error) {
              ...
              if (error !== RongIMLib.ErrorCode.TIMEOUT) {
                RongIMLib.Logger.writeLog({
                  tag: RongIMLib.LoggerTag.IM.L_QUERY_MSG_E,
                  level: RongIMLib.LoggerLevel.E,
                  type: RongIMLib.LoggerType.IM,
                  content: {
      ...
      Bridge.prototype.setListener = function () {
        ...
        Channel._ReceiveMessageListener = {
          onReceived: function (msg, count, hasMore) {
            RongIMLib.RongUtil.forEach(
              RongIMLib.RongIMClient.messageListeners,
              function (watch) {
                RongIMLib.RongUtil.isFunction(watch) &&
                  watch(msg, count, hasMore);
              }
            );
          },
        };
    ...
    var MessageHandler = (function () {
      ...
      MessageHandler.prototype.handleChrmKVPullMsg = function (msg) {
        try {
          ...
          var data = RongIMLib.CallbackMapping.getInstance().mapping(
            RongIMLib.RongIMClient.Protobuf[pbtype].decode(msg.data),
            pbtype
          );
      ...
      MessageHandler.prototype.onReceived = function (
        ...
        if (msg._name != "PublishMessage") {
          ...
          if (msg.getTopic() == "s_ntf") {
            ...
            try {
              ...
              RongIMLib.Logger.writeLog({
                tag: RongIMLib.LoggerTag.IM.L_DECODE_MSG_E,
                level: RongIMLib.LoggerLevel.E,
                type: RongIMLib.LoggerType.IM,
                content: { stack: e, msg: "MessageHandler -> onReceived" },
              });
              return;
            }
        ...
        if (isPersited) {
          ...
          if (isReceiver && message.senderUserId != Bridge._client.userId) {
            ...
            if (RongIMLib.RongUtil.supportLocalStorage()) {
              ...
              var newUnreadCount = RongIMLib.UnreadCountHandler.add(
        ...
        if (
          ...
          if (
            RongIMLib.RongUtil.isUndefined(receiptResponseMsg) ||
            RongIMLib.RongUtil.isNull(receiptResponseMsg)
          ) {
            receiptResponseMsg = new RongIMLib.ReadReceiptResponseMessage({});
          }
          var receiptMessageDic = receiptResponseMsg.receiptMessageDic || {},
            uIds = receiptMessageDic[Bridge._client.userId],
            sentkey = "",
            sentObj;
          ...
          if (uIds) {
            ...
            receiptResponseMsg.receiptMessageDic[Bridge._client.userId] =
              cbuIds;
      ...
      MessageHandler.prototype.handleMessage = function (msg) {
        ...
        switch (msg._name) {
          ...
          default:
            RongIMLib.Logger.writeLog({
              tag: RongIMLib.LoggerTag.IM.L_CATCH_UNKNOWN_MSG_E,
              level: RongIMLib.LoggerLevel.E,
              type: RongIMLib.LoggerType.IM,
              content: {
      ...
      QueryCallback.prototype.process = function (
        ...
        if (pbtype && data && status == 0) {
          try {
            ...
            RongIMLib.Logger.writeLog({
              tag: RongIMLib.LoggerTag.IM.L_DECODE_QUERY_DATA_E,
              level: RongIMLib.LoggerLevel.E,
              type: RongIMLib.LoggerType.IM,
              content: {
                stack: e,
      ...
      ConnectAck.prototype.process = function (status, userId, timestamp) {
        ...
        if (status == 0) {
          ...
          if (this._client.reconnectObj.onSuccess) {
            ...
            isNotifyConversationList &&
              RongIMLib.RongIMClient._dataAccessProvider.getRemoteConversationList(
                {
    ...
    var Navigation = (function () {
      ...
      Navigation.prototype.requestNavi = function (
        ...
        if (unignore) {
          ...
          var isNotExpired =
            currentTime - naviSavedTime < RongIMLib.RongIMClient.NavExpiredTime;
          if (
            isSameUser &&
            isSameType &&
            hasServers &&
            RongIMLib.RongUtil.hasValidWsUrl(servers) &&
            isNotExpired
          ) {
            RongIMLib.RongIMClient._memoryStore.voipStategy =
              storage.getItem("voipStrategy");
            var openMp = storage.getItem("openMp" + uId);
            RongIMLib.RongIMClient._memoryStore.depend.openMp = openMp;
            var storageProtocol = storage.getItem(Navigation.StoreProtocolKey);
            storageProtocol &&
              RongIMLib.RongIMClient.setProtocol(storageProtocol);
            _onsuccess();
            return;
          }
        }
        ...
        var isWSPingJSONP = depend.isWSPingJSONP;
        var isSupportRequestHeaders =
          RongIMLib.RongUtil.isSupportRequestHeaders();
        ...
        var consume = function () {
          if (isRange()) {
            ...
            context.getNaviSuccess(
              naviResp,
              RongIMLib.RongUtil.getValidNavi(naviHost)
            );
            _onsuccess();
            return;
          }
      ...
      Navigation.prototype.request = function (
        ...
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.L_GETN_T,
          level: RongIMLib.LoggerLevel.I,
          type: RongIMLib.LoggerType.IM,
          content: {
            url: url,
        ...
        return RongIMLib.RongUtil.request({
          ...
          success: function (result) {
            ...
            RongIMLib.Logger.writeLog({
              tag: RongIMLib.LoggerTag.IM.L_GETN_R,
              level: RongIMLib.LoggerLevel.I,
              type: RongIMLib.LoggerType.IM,
              content: {
                code: 0,
    ...
    var SocketTransportation = (function () {
      ...
      SocketTransportation.prototype.onClose = function (ev) {
        ...
        if (ev.code == 1006 && !this._status) {
          ...
          if (
            !me.connectedTime ||
            currentTime - me.connectedTime <=
              SocketTransportation.MinConnectTime
          ) {
      ...
      SocketTransportation.prototype.onError = function (error) {
        ...
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.L_WS_ERR_E,
          level: RongIMLib.LoggerLevel.E,
          type: RongIMLib.LoggerType.IM,
          content: {
  ...
  (function (RongIMLib) {
    ...
    var IMHandler = (function () {
      ...
      IMHandler.isIncludeNavi = function (token) {
        var navMarkIndex = RongIMLib.RongUtil.indexOf(
          token,
          RongIMLib.RongIMClient.NavMarkInToken
        );
      ...
      IMHandler.getNavsByToken = function (token, protocol) {
        ...
        if (isIncludeNavi) {
          ...
          var navDomains = navsText.split(
            RongIMLib.RongIMClient.NavSeparatorInToken
          );
    ...
    var MessageUtil = (function () {
      ...
      MessageUtil.messageParser = function (entity, onReceived, offlineMsg) {
        ...
        try {
          ...
          isUseDef = true;
          RongIMLib.Logger.writeLog({
            tag: RongIMLib.LoggerTag.IM.L_PARSE_MSG_E,
            level: RongIMLib.LoggerLevel.E,
            type: RongIMLib.LoggerType.IM,
            content: {
              stack: ex,
        ...
        try {
          ...
          message.disableNotification =
            MessageUtil.isDisableNotification(status);
        } catch (error) {
    ...
    var getKVProsumer = function (chrmId) {
      ...
      if (!kvProsumer) {
        kvProsumer = chrmKVProsumerCaches[chrmId] =
          new RongIMLib.RongUtil.Prosumer();
      }
      return kvProsumer;
    };
    var ChrmKVHandler = (function () {
      ...
      ChrmKVHandler.pull = function (chrmId, time) {
        ...
        var event =
          RongIMLib.RongIMClient._dataAccessProvider.pullChatroomEntry;
      ...
      ChrmKVHandler.setEntries = function (chrmId, entity) {
        ...
        var event = isFullUpdate
          ? ChrmKVHandler.setFullEntries
          : ChrmKVHandler.setIncreEntries;
        var kvCache = getKVCache(chrmId);
      ...
      ChrmKVHandler.setEntry = function (
        chrmId,
        chatroomEntry,
        status,
        userId
      ...
      ChrmKVHandler.setIncreEntries = function (chrmId, entries) {
        var kvCache = getKVCache(chrmId);
        var currentUserId =
          RongIMLib.RongIMClient.getInstance().getCurrentUserId();
        var optEvent = function (entity, isOverwrite, eventName) {
          var key = entity.key,
            value = entity.value;
          var isLatestedKeySetBySelf =
            kvCache.getSetUserId(key) === currentUserId;
        ...
        RongIMLib.RongUtil.forEach(entries, function (entity) {
          var entityContent = RongInnerTools.getChrmEntityByStatus(
            entity.status
          );
    ...
    var RongInnerTools = (function () {
      ...
      RongInnerTools.getChrmEntityByStatus = function (status) {
        ...
        var entityOpt = isDelete
          ? RongIMLib.ChatroomEntityOpt.DELETE
          : RongIMLib.ChatroomEntityOpt.UPDATE;
        return {
    ...
    var UnreadCountHandler = (function () {
      ...
      UnreadCountHandler.set = function (type, id, count, sentTime) {
        ...
        var value = sentTime
          ? RongIMLib.RongUtil.tplEngine(UnreadCountHandler.ValueTemp, {
              count: count,
              sentTime: sentTime,
            })
          : count;
      ...
      UnreadCountHandler.getAll = function (types) {
        ...
        if (types) {
          RongIMLib.RongUtil.forEach(types, function (type) {
            ...
            var unreadKeys =
              RongIMLib.RongIMClient._storageProvider.getItemKeyList(key);
            setTotal(unreadKeys);
          });
        } else {
    ...
    var ConversationStatusManager = (function () {
      function ConversationStatusManager(option) {
        ...
        this.option = option;
        this.storageKey = RongIMLib.RongUtil.tplEngine(
          ConversationStatusStoreUserKey,
          {
            appkey: appkey,
            userId: userId,
          }
      ...
      ConversationStatusManager.prototype._formatUpdatedStatus = function (
        status,
        type,
        targetId
      ) {
      ...
      ConversationStatusManager.prototype.set = function (
        type,
        targetId,
        status
      ) {
        ...
        if (updateTime >= currentStatus.updateTime) {
          ...
          var updatedStatusItem = this._formatUpdatedStatus(
            status,
            type,
            targetId
          );
      ...
      ConversationStatusManager.prototype.get = function (type, targetId) {
        ...
        var notificationStatus = status.notificationStatus,
          isTop = status.isTop,
          updateTime = status.updateTime;
        return {
          notificationStatus:
            notificationStatus ||
            RongIMLib.ConversationNotificationStatus.NOTIFY,
          isTop: isTop || false,
          updateTime: updateTime || 0,
        };
      };
      ConversationStatusManager.prototype.pull = function (option) {
        if (RongIMLib.RongIMClient._memoryStore.depend.isPolling) return; //长轮训关闭会话状态设置
        option = option || {};
        var self = this;
        var _a = this,
          server = _a.option.server,
          pullProsumer = _a.pullProsumer,
        ...
        pullProsumer.consume(function (params, next) {
          ...
          var lastUpdateTime =
            allStatus[ConversationStatusPullTimeStoreKey] || 0;
          var updateTime = params.time,
    ...
    var FixedNaviRespHandler = (function () {
      ...
      FixedNaviRespHandler.baseResp = {
        ...
        logSwitch: 1,
        logPolicy:
          '{"url": "logcollection.ronghub.com","level": 1,"itv": 6,"times": 5}',
    ...
    var JoinedChatroomSyner = (function () {
      function JoinedChatroomSyner(option) {
        ...
        var self = this;
        option = option || {};
        self.key = RongIMLib.RongUtil.tplEngine(
          "{appkey}-{userId}-joinedChrm",
          {
    ...
    var CommandMessage = (function () {
      function CommandMessage(message) {
        ...
        try {
          ...
          this.data = message.data;
          RongIMLib.Logger.writeLog({
            tag: RongIMLib.LoggerTag.IM.A_INIT_CMD_MSG_E,
            level: RongIMLib.LoggerLevel.E,
            type: RongIMLib.LoggerType.IM,
            content: {
              stack: e,
    ...
    var ProfileNotificationMessage = (function () {
      function ProfileNotificationMessage(message) {
        ...
        try {
          ...
          this.data = message.data;
          RongIMLib.Logger.writeLog({
            tag: RongIMLib.LoggerTag.IM.A_INIT_PROFILE_MSG_E,
            level: RongIMLib.LoggerLevel.E,
            type: RongIMLib.LoggerType.IM,
            content: {
              stack: e,
    ...
    var CommandNotificationMessage = (function () {
      function CommandNotificationMessage(message) {
        ...
        try {
          ...
          this.data = message.data;
          RongIMLib.Logger.writeLog({
            tag: RongIMLib.LoggerTag.IM.A_INIT_CMD_NOTI_MSG_E,
            level: RongIMLib.LoggerLevel.E,
            type: RongIMLib.LoggerType.IM,
            content: {
              stack: e,
  ...
  (function (RongIMLib) {
    ...
    var RCCombineMessage = (function () {
      ...
      RCCombineMessage.obtain = function (
        remoteUrl,
        nameList,
        summaryList,
        conversationType
    ...
    var ReferenceMessage = (function () {
      function ReferenceMessage(message) {
        ...
        if (arguments.length == 0) {
          throw new Error(
            "Can not instantiate with empty parameters, use obtain method instead -> ReferenceMessage."
          );
        }
        this.content = message.content;
  ...
  (function (RongIMLib) {
    var ServerDataProvider = (function () {
      ...
      ServerDataProvider.prototype.connect = function (
        ...
        var StartReportTag = isReconnect
          ? RongIMLib.LoggerTag.IM.L_RECO_T
          : RongIMLib.LoggerTag.IM.A_CONN_T;
        var EndReportTag = isReconnect
          ? RongIMLib.LoggerTag.IM.L_RECO_R
          : RongIMLib.LoggerTag.IM.A_CONN_R;
        !isIgnoreReportStart &&
          RongIMLib.Logger.writeLog({
            tag: StartReportTag,
            level: RongIMLib.LoggerLevel.I,
            ...
            onSuccess: function (data) {
              setTimeout(function () {
                ...
                RongIMLib.Logger.writeLog({
                  ...
                  level: RongIMLib.LoggerLevel.I,
                  type: RongIMLib.LoggerType.IM,
                  content: { desc: "connection succeeded" },
                });
                self.conversationStatusManager =
                  new RongIMLib.ConversationStatusManager({
                ...
                self.conversationStatusManager.watchChanged(function (status) {
                  RongIMLib.RongUtil.forEach(
                    RongIMLib.RongIMClient.conversationStatusListeners,
                    function (event) {
                      event(status);
                    }
                  );
                ...
                self.getVoipInfo({
                  onSuccess: function (VoipInfo) {
                    try {
                      VoipInfo &&
                        RongIMLib.RongUtil.forEach(
                          RongIMLib.RongIMClient.settingListeners,
                          function (listener) {
              ...
              if (e == RongIMLib.ConnectionState.TOKEN_INCORRECT || !e) {
                setTimeout(function () {
                  ...
                  RongIMLib.Logger.writeLog({
                    ...
                    content: {
                      ConnectionState:
                        RongIMLib.ConnectionState.TOKEN_INCORRECT,
                    },
                  });
                });
              } else {
      ...
      ServerDataProvider.prototype.reconnect = function (callback, config) {
        ...
        if (
            ...
            auto: function () {
              var repeatConnect = function (options) {
                ...
                var repeat = function () {
                  ...
                  RongIMLib.RongIMClient._memoryStore.autoReconnectTimer =
                    timer;
                };
                repeat();
              };
              var protocol =
                RongIMLib.RongIMClient._memoryStore.depend.protocol;
              var url =
                config.url ||
                "cdn.ronghub.com/RongIMLib-2.2.6.min.js?t=" + Date.now();
              var pathConfig = {
                protocol: protocol,
                path: url,
              };
          ...
          RongIMLib.Logger.writeLog({
            tag: RongIMLib.LoggerTag.IM.L_RECO_E,
            level: RongIMLib.LoggerLevel.E,
            type: RongIMLib.LoggerType.IM,
            content: {
              msg: {
      ...
      ServerDataProvider.prototype.getRemoteHistoryMessages = function (
        ...
        var topic =
          ...
          HistoryMsgType[RongIMLib.ConversationType.PRIVATE];
      ...
      ServerDataProvider.prototype.addMemberToDiscussion = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.ChannelInvitationInput();
      ...
      ServerDataProvider.prototype.createDiscussion = function (
        ...
        var modules =
            new RongIMLib.RongIMClient.Protobuf.CreateDiscussionInput(),
          self = this;
      ...
      ServerDataProvider.prototype.removeMemberFromDiscussion = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.ChannelEvictionInput();
      ...
      ServerDataProvider.prototype.setDiscussionInviteStatus = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.ModifyPermissionInput();
      ...
      ServerDataProvider.prototype.joinChatRoom = function (
        ...
        var self = this;
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.A_JCTR_T,
          level: RongIMLib.LoggerLevel.I,
          type: RongIMLib.LoggerType.IM,
          content: {
                  ...
                  0,
                  {
                    onSuccess: function (result) {
                      ...
                      setTimeout(function () {
                        callback.onSuccess();
                        RongIMLib.Logger.writeLog({
                          tag: RongIMLib.LoggerTag.IM.A_JCTR_R,
                          level: RongIMLib.LoggerLevel.I,
                          type: RongIMLib.LoggerType.IM,
                          content: {
                            chatroomId: chatroomId,
              ...
              RongIMLib.Bridge._client.queryMessage(
                ...
                1,
                {
                  onSuccess: function (collection) {
                    ...
                    if (latestMessage) {
                      latestMessage =
                        RongIMLib.MessageUtil.messageParser(latestMessage);
      ...
      ServerDataProvider.prototype.getChatRoomInfo = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.QueryChatroomInfoInput();
        modules.setCount(count);
        modules.setOrder(order);
        RongIMLib.RongIMClient.bridge.queryMsg(
          "queryChrmI",
      ...
      ServerDataProvider.prototype.quitChatRoom = function (
        ...
        var self = this;
        RongIMLib.Logger.writeLog({
          tag: RongIMLib.LoggerTag.IM.A_QCTR_T,
          level: RongIMLib.LoggerLevel.I,
          type: RongIMLib.LoggerType.IM,
          content: {
            chatroomId: chatroomId,
        ...
        RongIMLib.RongIMClient.bridge.queryMsg(
          ...
          chatroomId,
          {
            onSuccess: function () {
              RongIMLib.Bridge._client &&
                RongIMLib.Bridge._client.clearCacheMessageIds();
              setTimeout(function () {
                RongIMLib.Logger.writeLog({
                  tag: RongIMLib.LoggerTag.IM.A_QCTR_R,
                  level: RongIMLib.LoggerLevel.I,
                  type: RongIMLib.LoggerType.IM,
                  content: {
                    chatroomId: chatroomId,
      ...
      ServerDataProvider.prototype.setChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
        ...
        var key = chatroomEntry.key,
          value = chatroomEntry.value;
        var isKeyInValid =
          !RongIMLib.RongUtil.isLengthLimit(
            key,
            RongIMLib.ChatroomEntityLimit.KEY,
            1
          ) || !RongIMLib.ChrmKVHandler.isKeyValid(key);
        var isValueInValid = !RongIMLib.RongUtil.isLengthLimit(
          value,
          RongIMLib.ChatroomEntityLimit.VALUE,
          1
        );
      ...
      ServerDataProvider.prototype.forceSetChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
      ...
      ServerDataProvider.prototype.removeChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
      ...
      ServerDataProvider.prototype.forceRemoveChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {
      ...
      ServerDataProvider.prototype.refreshChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        chatroomEntryOpt,
        callback
        ...
        var status = RongIMLib.RongInnerTools.getChrmEntityStatus(
          chatroomEntry,
          chatroomEntryOpt
        );
        var currentUserId =
        ...
        if (chatroomEntry.isSendNotification) {
          ...
          var msgModules =
            new RongIMLib.RongIMClient.Protobuf.UpStreamMessage();
          ...
          msgModules.setSessionId(
            RongIMLib.RongIMClient.MessageParams[
              msg.messageName
            ].msgTag.getMessageTag()
          );
          msgModules.setClassname(
            RongIMLib.RongIMClient.MessageParams[msg.messageName].objectName
          );
        ...
        RongIMLib.RongIMClient.bridge.queryMsg(
          ...
          chatroomId,
          {
            onSuccess: function (ret) {
              var currentUserId =
                RongIMLib.RongIMClient.getInstance().getCurrentUserId();
              RongIMLib.ChrmKVHandler.setEntry(
                chatroomId,
                chatroomEntry,
                status,
                currentUserId
      ...
      ServerDataProvider.prototype.getChatroomEntry = function (
        chatroomId,
        key,
        callback
      ) {
      ...
      ServerDataProvider.prototype.getAllChatroomEntries = function (
        chatroomId,
        callback
      ) {
        var isInChatRoom = this.joinedChrmManager.isInChrm(chatroomId);
      ...
      ServerDataProvider.prototype.pullChatroomEntry = function (
        chatroomId,
        time,
        callback
      ) {
      ...
      ServerDataProvider.prototype.getBlacklistStatus = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.BlackListStatusInput();
        modules.setUserId(userId);
        RongIMLib.RongIMClient.bridge.queryMsg(
          24,
          RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()),
      ...
      ServerDataProvider.prototype.removeFromBlacklist = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.RemoveFromBlackListInput();
        modules.setUserId(userId);
        RongIMLib.RongIMClient.bridge.queryMsg(
          22,
          RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()),
      ...
      ServerDataProvider.prototype.getFileToken = function (
        ...
        var fileName = RongIMLib.RongUtil.generateUploadFileName(
          fileType,
          fileName
        );
        // 获取上传地址
        var domains =
          RongIMLib.RongIMClient._storageProvider.getItem("upload_domains") ||
          "{}";
      ...
      ServerDataProvider.prototype.getFileUrl = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.GetQNdownloadUrlInput();
        modules.setType(fileType);
        modules.setKey(fileName);
        if (oriName) {
      ...
      ServerDataProvider.prototype.getVoipInfo = function (callback) {
        if (RongIMLib.RongIMClient._memoryStore.depend.isPolling) return; //长轮训关闭实时配置，IE 现不支持音视频
        // 获取最新值
            ...
            onSuccess: function (result) {
              ...
              for (var i = 0, max = items.length; i < max; i++) {
                ...
                if (item.key === "VoipInfo") {
                  ...
                  if (RongIMLib.RongIMClient._memoryStore.depend.isPolling) {
                    value = new RongIMLib.BinaryHelper().readUTF(
                      value.offset
                        ? RongIMLib.MessageUtil.ArrayForm(value.buffer).slice(
                            value.offset,
                            value.limit
                          )
                        : value
                    ...
                    value = new RongIMLib.BinaryHelper().readUTF(
                      value.offset
                        ? RongIMLib.MessageUtil.ArrayFormInput(
                            value.buffer
                          ).subarray(value.offset, value.limit)
                        : value
                    );
                  }
                  voipInfo = value;
      ...
      ServerDataProvider.prototype.getPullSetting = function (
        callback,
        version
      ) {
        var modules =
          new RongIMLib.RongIMClient.Protobuf.PullUserSettingInput();
        ...
        RongIMLib.RongIMClient.bridge.queryMsg(
          ...
          RongIMLib.Bridge._client.userId,
          {
            onSuccess: function (result) {
              result = result || {};
              result.version = RongIMLib.MessageUtil.int64ToTimestamp(
                result.version
              );
              setTimeout(function () {
                callback.onSuccess(result);
      ...
      ServerDataProvider.prototype.setOfflineMessageDuration = function (
        duration,
        callback
      ) {
        this.getPullSetting({
          onSuccess: function (result) {
             ...
             */
            var modules =
              new RongIMLib.RongIMClient.Protobuf.GetQNupTokenOutput();
      ...
      ServerDataProvider.prototype.sendMessage = function (
        ...
        if (
          RongIMLib.RongUtil.getByteLength(encodedContent) >
          RongIMLib.RongIMClient.MaxMessageContentBytes
        ) {
          setTimeout(function () {
            sendCallback.onError(
              RongIMLib.ErrorCode.RC_MSG_CONTENT_EXCEED_LIMIT
            );
          });
          return;
        }
          ...
          targetId,
          {
            ...
            onError: function (errorCode, _msg) {
              ...
              if (
                ...
                RongIMLib.RongIMClient._memoryStore.converStore.latestMessage =
                  msg;
              }
              RongIMLib.RongIMClient._dataAccessProvider.addMessage(
                conversationType,
        ...
        RongIMLib.RongIMClient.bridge.queryMsg(
          ...
          targetId,
          {
            onSuccess: function () {
              ...
              isRemoved &&
                RongIMLib.RongIMClient._dataAccessProvider.Conversation._notify(
                  RongIMLib.RongIMClient._memoryStore.conversationList
                );
              callback.onSuccess(true);
            },
      ...
      ServerDataProvider.prototype.deleteRemoteMessages = function (
        conversationType,
        targetId,
        messages,
        callback
        ...
        for (
          ...
          if (
            ...
            if (RongIMLib.RongUtil.supportLocalStorage()) {
              ...
              var count = RongIMLib.UnreadCountHandler.get(
                conversationType,
                targetId
              );
      ...
      ServerDataProvider.prototype.getConversationList = function (
        ...
        if (
          !isSync &&
          (isLocalInclude ||
            RongIMLib.RongIMClient._memoryStore.isFullConversations)
        ) {
          setTimeout(function () {
            var _list = JSON.parse(JSON.stringify(list));
            var localList = _list.slice(0, count);
            if (conversationTypes) {
              localList = that.filterConversations(
                conversationTypes,
                localList
              );
            }
      ...
      ServerDataProvider.prototype.setUnreadCount = function (
        ...
        RongIMLib.UnreadCountHandler.set(
          conversationType,
          targetId,
          count,
          sentTime
      ...
      ServerDataProvider.prototype.getUnreadCount = function (
        ...
        var unreadCount = RongIMLib.UnreadCountHandler.get(
          conversationType,
          targetId
        );
        setTimeout(function () {
      ...
      ServerDataProvider.prototype.clearTotalUnreadCount = function (callback) {
        ...
        if (list) {
          ...
          for (var i = 0; i < list.length; i++) {
            var conver = list[i];
            if (conver) {
              isNotifyConversation = conver.unreadMessageCount
                ? true
                : isNotifyConversation;
              conver.unreadMessageCount = 0;
              me.cleanMentioneds(conver);
      ...
      ServerDataProvider.prototype.getConversationNotificationStatus =
      ...
      ServerDataProvider.prototype.setConversationStatus = function (
        type,
        targetId,
        statusItem,
        callback
        ...
        var self = this;
        var modules =
          new RongIMLib.RongIMClient.Protobuf.SessionStateModifyReq();
        var userId = RongIMLib.Bridge._client.userId;
        var time = +new Date();
        var stateItemModules = [];
        if (!RongIMLib.RongUtil.isUndefined(statusItem.notificationStatus)) {
          var isNotDisturbe =
            statusItem.notificationStatus ===
            RongIMLib.ConversationNotificationStatus.DO_NOT_DISTURB;
      ...
      ServerDataProvider.prototype.pullConversationStatus = function (
        time,
        callback
      ) {
        time = time || 0;
        ...
        RongIMLib.RongIMClient.bridge.queryMsg(
          ...
          {
            onSuccess: function (result) {
              var sessionStateList = result.state,
                lastTime = result.version;
              var sessionLength = sessionStateList.length;
              RongIMLib.RongUtil.forEach(
                sessionStateList,
                function (state, index) {
                  var type = state.type,
                    targetId = state.channelId,
                  ...
                  callback.onStatus(type, targetId, {
                    notificationStatus: isSilent
                      ? RongIMLib.ConversationNotificationStatus.DO_NOT_DISTURB
                      : RongIMLib.ConversationNotificationStatus.NOTIFY,
                    isTop: isTop,
                    updateTime:
                      RongIMLib.MessageUtil.int64ToTimestamp(updateTime),
                    isLastInAPull: isLastInAPull,
                  });
                }
              );
              callback.onSuccess(
                RongIMLib.MessageUtil.int64ToTimestamp(lastTime)
              );
            },
            onError: function (e) {
              setTimeout(function () {
      ...
      ServerDataProvider.prototype.setConversationNotificationStatus =
        function (params, callback) {
          var conversationType = params.conversationType;
          var targetId = params.targetId;
       ...
       * @param callback
       */
      ServerDataProvider.prototype.setRTCTotalRes = function (
        roomId,
        message,
        valueInfo,
        objectName,
        ...
        var arrayBuff = RongIMLib.MessageUtil.ArrayForm(
          modules.toArrayBuffer()
        );
        RongIMLib.RongIMClient.bridge.queryMsg(
          "userSetData",
          arrayBuff,
      ...
      ServerDataProvider.prototype.setRTCUserTotalRes = function (
        roomId,
        message,
        valueInfo,
        objectName,
      ...
      ServerDataProvider.prototype.getRTCOutData = function (
        ...
        var modules =
          new RongIMLib.RongIMClient.Protobuf.RtcQryUserOutDataInput();
        modules.setUserId(userIds);
        RongIMLib.RongIMClient.bridge.queryMsg(
          "rtcQryUserOutData",
          RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()),
  ...
  (function (RongIMLib) {
    var VCDataProvider = (function () {
      ...
      VCDataProvider.prototype.setConversationStatus = function (
        type,
        targetId,
        statusItem,
        callback
      ...
      VCDataProvider.prototype.setConnectionStatusListener = function (
        ...
        me.addon &&
          me.addon.setConnectionStatusListener(function (result) {
            var isCurrentConnected =
              me.connectionStatus === RongIMLib.ConnectionStatus.CONNECTED;
            var code = result;
            switch (result) {
              case 10:
      ...
      VCDataProvider.prototype.getRemoteConversationList = function (
        ...
        try {
          ...
          list.reverse();
          isGetHiddenConvers =
            typeof isGetHiddenConvers === "boolean"
              ? isGetHiddenConvers
              : false;
      ...
      VCDataProvider.prototype.setChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {};
      VCDataProvider.prototype.forceSetChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {};
      VCDataProvider.prototype.getChatroomEntry = function (
        chatroomId,
        key,
        callback
      ) {};
      VCDataProvider.prototype.getAllChatroomEntries = function (
        chatroomId,
        callback
      ) {};
      VCDataProvider.prototype.removeChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {};
      VCDataProvider.prototype.forceRemoveChatroomEntry = function (
        chatroomId,
        chatroomEntry,
        callback
      ) {};
      VCDataProvider.prototype.pullChatroomEntry = function (
        chatroomId,
        time,
        callback
      ) {};
      ...
      VCDataProvider.prototype.registerMessageType = function (
        ...
        RongIMLib.RongIMClient.RegisterMessage[messageType] = regMsg;
        RongIMLib.RongIMClient.RegisterMessage[messageType].messageName =
          messageType;
        registerMessageTypeMapping[objectName] = messageType;
      ...
      VCDataProvider.prototype.deleteRemoteMessages = function (
        conversationType,
        targetId,
        messages,
        callback
      ...
      VCDataProvider.prototype.setOfflineMessageDuration = function (
        duration,
        callback
      ) {
      ...
      VCDataProvider.prototype.setRTCUserTotalRes = function (
        roomId,
        message,
        valueInfo,
        objectName,
  ...
  (function (RongIMLib) {
    var Logger = (function () {
      ...
      Logger.writeLog = function (log) {
        ...
        var networkUnavailable =
          RongIMLib.RongIMClient._memoryStore.networkUnavailable;
        ...
        if (networkUnavailable) {
          if (
            log.level == RongIMLib.LoggerLevel.E ||
            log.level == RongIMLib.LoggerLevel.W
          ) {
      ...
      Logger.reportRTLog = function () {
        var self = this;
        var isUserCloseLogger =
          RongIMLib.RongIMClient._memoryStore.loggerSwitch === "off";
        ...
        var _robustUpload = function () {
          ...
          setTimeout(function () {
            var csvLog = RongIMLib.LoggerUtil.handleLog({
              level: level,
              type: RongIMLib.LoggerReportType.REAL_TIME_LOG,
            });
            var encodeCsvLog = RongIMLib.TextCompressor.compress(csvLog);
            var entireUrl = RongIMLib.LoggerUtil.getEntireUrl({
              url: url,
              type: RongIMLib.LoggerReportType.REAL_TIME_LOG,
            });
            ...
            RongIMLib.RongUtil.request({
              ...
              success: function (data) {
                Logger.writeLog({
                  tag: RongIMLib.LoggerTag.IM.G_UP_LOG_S,
                  level: RongIMLib.LoggerLevel.D,
                  type: RongIMLib.LoggerType.IM,
                  content: {
              ...
              error: function (status, resText) {
                _robustUpload();
                Logger.writeLog({
                  tag: RongIMLib.LoggerTag.IM.G_UP_LOG_E,
                  level: RongIMLib.LoggerLevel.D,
                  type: RongIMLib.LoggerType.IM,
                  content: {
                    desc: "report real-time log",
      ...
      Logger.reportMNLog = function (policy) {
        ...
        if (
          policy.platform !== "Web" ||
          policy.logId === self.loggerCache.logId
        ) {
          return;
        }
        ...
        var _robustUpload = function () {
          ...
          setTimeout(function () {
            var csvLog = RongIMLib.LoggerUtil.handleLog({
              ...
              type: RongIMLib.LoggerReportType.MSG_NOTIF_LOG,
            });
  ...
  (function (RongIMLib) {
    var LoggerUtil = (function () {
      ...
      LoggerUtil.handleLog = function (conf) {
        ...
        if (self.isRealTimeLogType(conf.type)) {
          ...
          RongIMLib.RongUtil.forEach(logs, function (log) {
            if (
              log.level <= conf.level &&
              log.time >= conf.startTime &&
              log.time <= conf.endTime
            ) {
              csvLog += self.genCSVLog(log);
            }
          });
      ...
      LoggerUtil.getEntireUrl = function (opt) {
        var self = this;
        var tLogTpl =
          "{protocol}{url}?version={version}&appkey={appkey}&userId={userId}&deviceId={deviceId}&deviceInfo={deviceInfo}&platform={platform}";
        var mLogTpl =
        ...
        var paramObj = {
          ...
          appkey:
            RongIMLib.RongIMClient._memoryStore.appKey || "Unknown appkey",
        ...
        if (self.isRealTimeLogType(opt.type)) {
          ...
          entireUrl = RongIMLib.RongUtil.tplEngine(
            mLogTpl,
            RongIMLib.RongUtil.extend(paramObj, {
              logId: opt.logId,
            })
          );
        }
      ...
      LoggerUtil.isLogCmdMsg = function (message) {
        ...
        if (
          message.messageType ===
            RongIMLib.RongIMClient.MessageType["LogCommandMessage"] &&
          message.senderUserId === "rongcloudsystem"
        ) {
          flag = true;
        }
        return flag;
  ...
  (function (RongIMLib) {
    var sessionStorageProvider = (function () {
      ...
      sessionStorageProvider.prototype.setItem = function (
        composedKey,
        object
      ) {
        if (composedKey) {
        ...
        if (!window["JSON"]) {
          window["JSON"] = (function () {
            ...
            JSON.quote = function (string) {
              ...
              return me.rx_escapable.test(string)
                ? '"' +
                    string.replace(me.rx_escapable, function (a) {
                      var c = me.meta[a];
  ...
  (function (RongIMLib) {
        ...
        for (var i = 0, len = this.conversationList.length; i < len; i++) {
          if (
            ...
            this.conversationList.unshift(
              this.conversationList.splice(i, 1)[0]
            );
            isAdd = false;
            break;
          }
    ...
    var RongAjax = (function () {
      ...
      RongAjax.prototype.send = function (callback) {
        var me = this;
        me.options.url ||
          (me.options.url = "http://upload.qiniu.com/putb64/-1");
    ...
    var RongUtil = (function () {
      ...
      RongUtil.getValidNavi = function (naviHost) {
        ...
        var naviProtocol = RongUtil.getUrlProtocol(navi),
          localProtocol = RongUtil.getLocalProtocol();
        // 本地为 https, 但却传入 http 时, 强制转化为 https
        if (
          naviProtocol === HttpProtocol.http &&
          localProtocol === "https://"
        ) {
      ...
      RongUtil.string10to64 = function (number) {
        var chars =
            "0123456789abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZa0".split(
              ""
            ),
    ...
    var TextCompressor = (function () {
      ...
      TextCompressor.compress = function (data) {
        ...
        var encodeNormalBlock = function () {
          if (normalBlockBuffer.length > 0) {
            ...
            if (normalBlock.length > 26) {
              ...
              var normalExtBlockHeader = String.fromCharCode(
                self.dataType.NormalExt | normalExtBlockLength.length
              );
              compressedData.push(normalExtBlockHeader + normalExtBlockLength);
            } else {
              var normalBlockHeader = String.fromCharCode(
                self.dataType.Normal | normalBlock.length
              );
        ...
        while (i < data.length) {
          ...
          encodeNormalBlock();
          //编码压缩数据块
          var compressedBlockHeader = String.fromCharCode(
            self.dataType.Compressed | (offset.length << 2) | length.length
          );
        ...
        var tailBlockHeader = String.fromCharCode(
          self.dataType.Tail | dataLengthTo62.length
        );
      ...
      TextCompressor.uncompress = function (data) {
        ...
        label1: do {
          ...
          switch (headerType) {
            ...
            default:
              throw new Error(
                "Data parsing error,at " + i + " header:" + headerType
              );
          }
        } while (i < data.length);
        return result;
      ...
      TextCompressor.indexOf = function (map, source, fromIndex) {
        ...
        for (var i = 0, len = items.length; i < len; i++) {
          ...
          if (result.length > 2) {
            if (
              source.charAt(item + result.length - 1) !=
              source.charAt(fromIndex + result.length - 1)
            ) {
              continue;
            }
          }
 ...
 * auth: yangchuan
 * update:
 * Socket.prototype._encode
 * 增加 x.getMessageId 判断
 *
 * date: 2020-xx-xx
 * auth: yangchuan
 * update:
 * 重连网络监测增加 ?t=Date.now() 防止缓存
 *
 * date: 2020-12-1
 * auth: yangchuan
 * update:
 * Channel.prototype.changeConnectType 改变时 改变 RongIMLib.Transportations._TransportType
 */
