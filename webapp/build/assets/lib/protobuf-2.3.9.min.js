(function (c, d) {
  ...
  var e = (function (j, k, f) {
    ...
    l.TYPES = {
      int32: { name: "int32", wireType: l.WIRE_TYPES.VARINT, defaultValue: 0 },
      uint32: {
        name: "uint32",
      ...
      float: { name: "float", wireType: l.WIRE_TYPES.BITS32, defaultValue: 0 },
      enum: { name: "enum", wireType: l.WIRE_TYPES.VARINT, defaultValue: 0 },
      message: {
        name: "message",
        wireType: l.WIRE_TYPES.LDELIM,
        defaultValue: null,
    ...
    l.DotProto = (function (s, t) {
      ...
      w._parseMessageField = function (o, y, z) {
        ...
        var A = { rule: y, type: "", name: "", options: {}, id: 0 };
        var B;
        if (y === "map") {
          if (z) {
      ...
      w._parseEnum = function (o) {
        ...
        while ((z = this.tn.next()) !== "}") {
          if (z === "option") {
            ...
            this.tn.skip("=");
            var y = { name: z, id: x(this.tn.next(), true) };
            z = this.tn.peek();
            if (z === "[") {
    ...
    l.Reflect = (function (V) {
      ...
      L.build = function (s) {
        ...
        var q = (function (y, E) {
          ...
          var z;
          if (Object.defineProperty) {
            Object.defineProperty(x, "$options", { value: E.buildOpt() }),
              Object.defineProperty(B, "$options", { value: x["$options"] }),
              Object.defineProperty(x, "$type", { value: E }),
              Object.defineProperty(B, "$type", { value: E });
          }
          return x;
        })(V, this);
        this._fields = [];
      ...
      S.build = function (o) {
        ...
        return (this.clazz = (function (r, w) {
          ...
          var s;
          if (Object.defineProperty) {
            Object.defineProperty(x, "$options", { value: w.buildOpt() }),
              Object.defineProperty(q, "$options", { value: x["$options"] }),
              Object.defineProperty(x, "$type", { value: w }),
              Object.defineProperty(q, "$type", { value: w });
          }
          return x;
        })(V, this));
      };
        ...
        if (this.ptr instanceof b.Namespace) {
          ...
          if (this.ptr instanceof b.Message.Field) {
            if (!q.TYPE.test(this.ptr.type)) {
              ...
              t = (
                this.ptr instanceof b.Message.ExtensionField
    ...
    l.Map = (function (q, b) {
      var r = function (w, x) {
        ...
        if (x) {
          ...
          for (var t = 0; t < s.length; t++) {
            ...
            this.map[this.keyElem.valueToString(u)] = { key: u, value: v };
          }
        }
      };
      var p = r.prototype;
      ...
      p.set = function (u, s) {
        ...
        this.map[this.keyElem.valueToString(v)] = { key: v, value: t };
        return this;
      };
      p.get = function (t) {
        var s = this.keyElem.valueToString(this.keyElem.verifyValue(t));
    ...
    var h = m(
      ""
    );
